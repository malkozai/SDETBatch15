...
public class Task3 {
    public static void main(String[] args) {
        ...
        System.out.println("Please enters two numbers starting point and ending point");
        ...
        for (int i = start; i <= end; i++) {
            if(i%2==0) {
               evenSum+=i; // it can also be written like this evenSum=evenSum+i

            }else{
                oddSum=oddSum+i; // it can also be written like this oddSum+=i
            }
        }
